                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item pe-4">
                                <a class="nav-link text-uppercase active " aria-current="page" href="#">Accueil</a>
                            </li>
                            <li class="nav-item pe-4">
                                <a class="nav-link text-uppercase" href="#ccm">Comment ça marche ?</a>
                            </li>
                            <li class="nav-item pe-4">
                                <a class="nav-link text-uppercase" href="#">E-shop</a>
                            </li>
                            <li class="nav-item pe-4">
        ...
        <div class="container my-5  py-5">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <p>
                        <button class="btn btn-order btn-lg me-5 helvetica">Louer maintenant</button>
                        <button class="btn btn-outline-info cc-btn-info btn-lg helvetica">Boutique</button>
                    </p>
                </div>
            </div>
        </div>
